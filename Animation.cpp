...
//------------------------------------------------------------------------------------------------------
void Animation::Draw(int xPosition, int yPosition, float movement_speed, double angle, FlipType flipType)
{
